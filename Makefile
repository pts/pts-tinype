...
all: hh1.exe hh2.exe hh4.exe hh6a.exe hh6b.exe hh6c.exe hh6d.exe hh7.exe box1.exe
...
clean:
	rm -f hh1.exe hh2.exe hh3g.exe hh3t.exe hh3w.exe hh4.exe hh5.exe hh6?.exe hh7.exe box1.exe
